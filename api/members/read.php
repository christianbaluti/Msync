...
try {
    ...
    $count_query = "SELECT COUNT(ms.id) FROM membership_subscriptions ms 
    ...
    // For debugging, it's helpful to log the error.
    // In production, you might want to avoid sending detailed error messages to the client.
    error_log("Database Error in /api/members/read.php: " . $e->getMessage());
